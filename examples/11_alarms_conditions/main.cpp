...
////
////    object_attr.displayName = UA_LOCALIZEDTEXT((char*)"en", (char*)"ConditionSourceObject");
...
////                                       UA_QUALIFIEDNAME(0, (char*)"Condition 1"), conditionSource,
...
////                                                     UA_NODEID_NULL, UA_NODEID_NUMERIC(0, UA_NS0ID_OFFNORMALALARMTYPE),
////                                                     UA_QUALIFIEDNAME(0, (char*)"Condition 2"), UA_NODEID_NUMERIC(0, UA_NS0ID_SERVER),
...
////    attr.displayName = UA_LOCALIZEDTEXT((char*)"en", (char*)"Activate Condition 1");
////    attr.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
////    UA_Boolean tboolValue = UA_FALSE;
////    UA_Variant_setScalar(&attr.value, &tboolValue, &UA_TYPES[UA_TYPES_BOOLEAN]);
////
////    UA_QualifiedName CallbackTestVariableName = UA_QUALIFIEDNAME(0, (char*)"Activate Condition 1");
...
////    UA_VariableAttributes attr = UA_VariableAttributes_default;
////    attr.displayName = UA_LOCALIZEDTEXT((char*)"en", (char*)"Change Severity Condition 2");
////    attr.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
////    UA_UInt16 severityValue = 0;
////    UA_Variant_setScalar(&attr.value, &severityValue, &UA_TYPES[UA_TYPES_UINT16]);
////
////    UA_QualifiedName CallbackTestVariableName = UA_QUALIFIEDNAME(0, (char*)"Change Severity Condition 2");
////    UA_NodeId parentNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER);
////    UA_NodeId parentReferenceNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES);
////    UA_NodeId variableTypeNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_BASEDATAVARIABLETYPE);
////    UA_Server_addVariableNode(server, UA_NODEID_NULL, parentNodeId,
...
////    UA_VariableAttributes attr = UA_VariableAttributes_default;
////    attr.displayName = UA_LOCALIZEDTEXT((char*)"en", (char*)"Return to Normal Condition 1");
////    attr.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
////    UA_Boolean rtn = 0;
////    UA_Variant_setScalar(&attr.value, &rtn, &UA_TYPES[UA_TYPES_BOOLEAN]);
////
////    UA_QualifiedName CallbackTestVariableName = UA_QUALIFIEDNAME(0, (char*)"Return to Normal Condition 1");
////    UA_NodeId parentNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER);
////    UA_NodeId parentReferenceNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES);
////    UA_NodeId variableTypeNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_BASEDATAVARIABLETYPE);
////    UA_Server_addVariableNode(server, UA_NODEID_NULL, parentNodeId,
...
////    UA_QualifiedName activeStateField = UA_QUALIFIEDNAME(0,(char*)"ActiveState");
////    UA_QualifiedName activeStateIdField = UA_QUALIFIEDNAME(0,(char*)"Id");
////    UA_Variant value;
////
////    UA_StatusCode retval = UA_Server_writeObjectProperty_scalar(server, conditionInstance_1, UA_QUALIFIEDNAME(0, (char*)"Time"),
...
////    */
////    UA_Server_writeObjectProperty_scalar(server, conditionInstance_2, UA_QUALIFIEDNAME(0, (char*)"Severity"),
...
////    UA_QualifiedName ackedStateField = UA_QUALIFIEDNAME(0,(char*)"AckedState");
////    UA_QualifiedName confirmedStateField = UA_QUALIFIEDNAME(0,(char*)"ConfirmedState");
////    UA_QualifiedName activeStateField = UA_QUALIFIEDNAME(0,(char*)"ActiveState");
////    UA_QualifiedName severityField = UA_QUALIFIEDNAME(0,(char*)"Severity");
////    UA_QualifiedName messageField = UA_QUALIFIEDNAME(0,(char*)"Message");
////    UA_QualifiedName commentField = UA_QUALIFIEDNAME(0,(char*)"Comment");
////    UA_QualifiedName retainField = UA_QUALIFIEDNAME(0,(char*)"Retain");
////    UA_QualifiedName idField = UA_QUALIFIEDNAME(0,(char*)"Id");
////
////    UA_StatusCode retval = UA_Server_writeObjectProperty_scalar(server, conditionInstance_1, UA_QUALIFIEDNAME(0, (char*)"Time"),
...
////    }
////
////    UA_LocalizedText messageValue = UA_LOCALIZEDTEXT((char*)"en", (char*)"Condition returned to normal state");
...
////    }
////
////    UA_LocalizedText commentValue = UA_LOCALIZEDTEXT((char*)"en", (char*)"Normal State");
...
////
////    return UA_Server_writeObjectProperty_scalar(server, *condition, UA_QUALIFIEDNAME(0, (char*)"Retain"),
...
////
////    UA_Boolean retain = UA_TRUE;
////    UA_Server_writeObjectProperty_scalar(server, conditionInstance_2, UA_QUALIFIEDNAME(0, (char*)"Retain"),
////                                         &retain, &UA_TYPES[UA_TYPES_BOOLEAN]);
////
////    UA_Variant value;
