...
public:
	...
	QUaProperty * addProperty(const QString &strBrowseName = QString())
	{
	...
	template<typename T = bool>
	QUaBaseDataVariable * addBaseDataVariable(const QString &strBrowseName = QString())
	{
		Q_UNUSED(strBrowseName);
	...
	template<typename T = bool>
	QUaBaseObject * addBaseObject(const QString &strBrowseName = QString())
	{
		Q_UNUSED(strBrowseName);
	...
	template<typename T = bool>
	QUaFolderObject * addFolderObject(const QString &strBrowseName = QString())
	{
		Q_UNUSED(strBrowseName);
