...
public:
	...
	QUaProperty * addProperty(const QString &strBrowseName = QStringLiteral(""))
	{
	...
	template<typename T = bool>
	QUaBaseDataVariable * addBaseDataVariable(const QString &strBrowseName = QStringLiteral(""))
	{
		Q_UNUSED(strBrowseName);
	...
	template<typename T = bool>
	QUaBaseObject * addBaseObject(const QString &strBrowseName = QStringLiteral(""))
	{
		Q_UNUSED(strBrowseName);
	...
	template<typename T = bool>
	QUaFolderObject * addFolderObject(const QString &strBrowseName = QStringLiteral(""))
	{
		Q_UNUSED(strBrowseName);
