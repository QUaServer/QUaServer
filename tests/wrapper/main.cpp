...
int main(int argc, char *argv[])
{
	...
	qDebug() << objBase1->get_browseName().second;
	...
	qDebug() << varBase1->get_browseName().second;
	...
	qDebug() << folder1->get_browseName().second;
	...
	qDebug() << objBaseNested1->get_browseName().second;
